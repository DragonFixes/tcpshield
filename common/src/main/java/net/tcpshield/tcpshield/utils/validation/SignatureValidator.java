package net.tcpshield.tcpshield.utils.validation;
...
public class SignatureValidator {
	...
	public SignatureValidator() throws IOException, NoSuchAlgorithmException, InvalidKeySpecException {
		byte[] encodedKey = ByteStreams.toByteArray(Objects.requireNonNull(SignatureValidator.class.getResourceAsStream("/signing_pub.key")));
